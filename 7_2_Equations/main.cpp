...
struct Equations
{
    ...
    long CalcSingleOperation(const long a, const long b, const int o)
    {
        ...
        else if (o == 3) return std::stol(std::to_string(a) + std::to_string(b));
        return 0;
    }
    ...
    void Calc()
    {
        ...
        {
            std::cout << 100 * ++i / this->equations.size() << "%\n";
            ...
            } while (nextPermutationWithRepetition(el.operators.begin(), el.operators.end(), 1, 3));
            // break;
        }
...
int main()
{
    ...
    // string filename("example_input"); // 11387
